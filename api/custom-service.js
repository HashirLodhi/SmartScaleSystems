    ...
    const htmlBody = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
          <tr><td style="padding: 8px 0; font-weight: bold; color: #555; width: 140px;">Full Name</td><td style="padding: 8px 0;">${safe.fullName}</td></tr>
        ...
        <div style="margin-top: 20px; padding: 16px; background: #f9f9f9; border-radius: 8px; border-left: 4px solid #666666;">
          ...
          <p style="margin: 0; color: #333; line-height: 1.6;">${safe.projectDetails}</p>
        </div>
