...
const routes = [
  {
    ...
    description: 'Smart Scale Systems builds AI agents, automation, machine learning, computer vision, and data solutions worldwide. End-to-end delivery from data to deployment.',
  },
  {
