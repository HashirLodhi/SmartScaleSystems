...
function buildFallbackReply(message, historyText) {
  ...
  if (/\b(contact|email|reach|talk|start|proposal)\b/.test(lower)) {
    return 'You can start through [Contact Us](/contact) or email **contact@smartscalesystems.tech**. The website states that the team responds within one business day with a clear action plan.';
  }
